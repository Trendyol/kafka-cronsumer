...
[![OpenSSF Scorecard](https://api.scorecard.dev/projects/github.com/Trendyol/kafka-cronsumer/badge)](https://scorecard.dev/viewer/?uri=github.com/Trendyol/kafka-cronsumer)
...
| `consumer.clientId`              | [see doc](https://pkg.go.dev/github.com/segmentio/kafka-go@v0.4.51#Dialer)                                                                                                                                                                                                                                                                                                                                        |                             |                                           |
...
| `consumer.minBytes`              | [see doc](https://pkg.go.dev/github.com/segmentio/kafka-go@v0.4.51#ReaderConfig.MinBytes)                                                                                                                                                                                                                                                                                                                         | 1                           |                                           |
| `consumer.maxBytes`              | [see doc](https://pkg.go.dev/github.com/segmentio/kafka-go@v0.4.51#ReaderConfig.MaxBytes)                                                                                                                                                                                                                                                                                                                         | 1 MB                        |                                           |
| `consumer.maxWait`               | [see doc](https://pkg.go.dev/github.com/segmentio/kafka-go@v0.4.51#ReaderConfig.MaxWait)                                                                                                                                                                                                                                                                                                                          | 10s                         |                                           |
| `consumer.commitInterval`        | [see doc](https://pkg.go.dev/github.com/segmentio/kafka-go@v0.4.51#ReaderConfig.CommitInterval)                                                                                                                                                                                                                                                                                                                   | 1s                          |                                           |
| `consumer.heartbeatInterval`     | [see doc](https://pkg.go.dev/github.com/segmentio/kafka-go@v0.4.51#ReaderConfig.HeartbeatInterval)                                                                                                                                                                                                                                                                                                                | 3s                          |                                           |
| `consumer.sessionTimeout`        | [see doc](https://pkg.go.dev/github.com/segmentio/kafka-go@v0.4.51#ReaderConfig.SessionTimeout)                                                                                                                                                                                                                                                                                                                   | 30s                         |                                           |
| `consumer.rebalanceTimeout`      | [see doc](https://pkg.go.dev/github.com/segmentio/kafka-go@v0.4.51#ReaderConfig.RebalanceTimeout)                                                                                                                                                                                                                                                                                                                 | 30s                         |                                           |
| `consumer.startOffset`           | [see doc](https://pkg.go.dev/github.com/segmentio/kafka-go@v0.4.51#ReaderConfig.StartOffset)                                                                                                                                                                                                                                                                                                                      | earliest                    |                                           |
| `consumer.retentionTime`         | [see doc](https://pkg.go.dev/github.com/segmentio/kafka-go@v0.4.51#ReaderConfig.RetentionTime)                                                                                                                                                                                                                                                                                                                    | 24h                         |                                           |
| `consumer.queueCapacity`         | [see doc](https://pkg.go.dev/github.com/segmentio/kafka-go@v0.4.51#ReaderConfig.QueueCapacity)                                                                                                                                                                                                                                                                                                                    | 100                         |                                           |
...
| `producer.clientId`              | [see doc](https://pkg.go.dev/github.com/segmentio/kafka-go@v0.4.51#Transport)                                                                                                                                                                                                                                                                                                                                     |                             |                                           |
| `producer.brokers`               | Broker address if it is not given, uses consumer.Brokers addr                                                                                                                                                                                                                                                                                                                                                     | consumer.Brokers addr       |                                           |
| `producer.batchSize`             | [see doc](https://pkg.go.dev/github.com/segmentio/kafka-go@v0.4.51#Writer.BatchSize)                                                                                                                                                                                                                                                                                                                              | 100                         |                                           |
| `producer.batchBytes`            | Limits `ProduceBatch` chunks by approximate uncompressed message bytes. `0` preserves the current single `WriteMessages` behavior. Single messages larger than the limit are still sent alone. The underlying kafka-go writer byte limit is set high internally because kafka-go checks it before compression; Kafka topic/broker `max.message.bytes` still applies to compressed messages.                                                                                 | 0                           | 1048576                                   |
| `producer.batchTimeout`          | [see doc](https://pkg.go.dev/github.com/segmentio/kafka-go@v0.4.51#Writer.BatchTimeout)                                                                                                                                                                                                                                                                                                                           | 1s                          |                                           |
| `producer.requiredAcks`          | [see doc](https://pkg.go.dev/github.com/segmentio/kafka-go@v0.4.51#RequiredAcks). Valid values: `RequireNone` (0), `RequireOne` (1), `RequireAll` (-1). When unset, defaults to `RequireNone`.                                                                                                                                                                                                                      | RequireNone (0)             |                                           |
| `producer.balancer`              | [see doc](https://pkg.go.dev/github.com/segmentio/kafka-go#Balancer)                                                                                                                                                                                                                                                                                                                                              | leastBytes                  |                                           |
| `producer.requiredAcks`          | [see doc](https://pkg.go.dev/github.com/segmentio/kafka-go@v0.4.47#RequiredAcks). Required acknowledgements for retry and dead-letter writes. Supported values are `kafka.RequireNone`, `kafka.RequireOne`, and `kafka.RequireAll`.                                                                                                                                                                                | RequireNone                 | `kafka.RequireAll`                        |
| `producer.compression`           | Compression codec used while producing retried messages to Kafka. Useful when retry messages are large and brokers enforce a maximum message size. Supported values are provided by `segmentio/kafka-go`, for example `kafka.Gzip`, `kafka.Snappy`, `kafka.Lz4`, and `kafka.Zstd`.                                                                                                                                 | uncompressed                | `kafka.Gzip`                              |
...
| `sasl.rack`                      | [see doc](https://pkg.go.dev/github.com/segmentio/kafka-go@v0.4.51#RackAffinityGroupBalancer)                                                                                                                                                                                                                                                                                                                     | ""                          |                                           |
